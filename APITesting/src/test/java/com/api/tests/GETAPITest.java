...
//		4.********************ALL HEADERS*************************
	...
	public void testGETwithheaders() throws ClientProtocolException, IOException {
		...
		headermap1.put("OAM_REMOTE_USER", "vgupt05");
		headermap1.put("DIVISION", "25");
		
		
		httpResponse=  restclient.get(uri,headermap1);
